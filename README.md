...
<p align="center">
<img src="https://i.pinimg.com/564x/7d/6f/69/7d6f69bb0e8a9ede668bb3b6cf61d473.jpg", width="500", height="500">
</p>

-----

### <p align="center">💥 fxcrypt 💥</p>

<br><br>
<p align="center">
<strong>
fxcrypt — самый мощный Python-обфускатор для скриптов Python,
<br>разработан <a href="https://github.com/localware">eternalware</a>.
<br><br>
Это позволяет вам запутать ваш скрипт более чем 10 слоями, сохраняя при этом его
<br>
очень компактным (один файл) и исполняемым на любой версии Python.
<br><br>
<br><br>
</strong>
<img src="https://media.discordapp.net/attachments/1089903184287383659/1090922344454819860/image.png?width=853&height=646" width="1202", height="642">
</p>
<br>

-----

### <p align="center">📀 Зависимости 📀</p>

<p align="center"><strong><i>Для того, чтобы программа работала, вы должны установить эти зависимости:</i></strong</p>
...
get_url= urllib.request.urlopen('https://www.github.com/localware/')

print('https://github.com/localware')
```
<br><br>
**Obfuscated**:<br>
```python3
